...
/**
 * Unit03 案例6 通过分页和流量统计演示ServletContext对象既可以读取常量，也可以读取变量。
 *
 * @author Double
 *
 */
public class FindEmpBySizeServlet extends HttpServlet {

	/**
	 *
	 */
	private static final long serialVersionUID = -3715895672001845493L;
	...
	protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		//执行分页查询(模拟)
		System.out.println("使用size进行分页查询员工数据");
