...
/**
 * 该类用于维护数据库连接的工具类
 * 使用C3P0连接池，JDBC_mysql_db.properties和事物管理ThreadLocal工具类
 * @author Double
 *
 */
public class C3P0_DBUtil {
	...
	static{
		...
		try {
			 ...
			 * 第二种路径写法
			 */
			//String path="src/main/java/jdbc/mysql/resources/JDBC_mysql_db.properties";
			//默认是的项目名路径
	...
	public static Connection getConnection() throws Exception {
		//调用getConnection()方法时，返回的是cpds.getConnection()
		//org.apache.commons.dbcp.SQLNestedException: Cannot get a connection
/*		tl.set(cpds.getConnection());
